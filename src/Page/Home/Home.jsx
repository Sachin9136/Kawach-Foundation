...
import Our_Stories from "../../components/Our_story/Our_story";
import Gallery_img from "../../components/Gallery_img/Gallery_img";
import Programme_services from "../Programme_Services/Programme_Services";
import Partner_slider from "../../components/Partner_slider/Partner_slider";
  ...
  return (
    <>
        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-10">
          ...
          <div className="md:w-3/5 w-full">
            <p className="text-2xl pb-2 text-gray-700 mb-6">
              In the bustling landscape of India, where health disparities can
              be stark and access to healthcare is often a luxury rather than a
              necessity, organizations like Kawach Foundation stand out as
              beacons of hope. Founded on the principle of serving the community
              and ensuring better health outcomes for all, Kawach Foundation
              operates as a non-profit organization dedicated to providing
              regular check-ups and conducting awareness camps throughout the
              country.
            </p>
            <p className="text-2xl pb-2 text-gray-700 mb-6">
      ...
      <Row className="py-5">
        ...
        <Heading
          className={"text-3xl font-semibold text-center pb-10 text-[#06B13D]"}
        >
          Visual Journey
        </Heading>
